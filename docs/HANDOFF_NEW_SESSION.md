...
- **Latest work**: **RB-40…44 landed** (this `agi` drain). Cover magic-byte sniff;
  ...
  `interior_pdf`). Prior: bands 233–263, RB-1…RB-38. Three KDP types = ebook /
  paperback / hardcover; virtual stand = `/view3d` (CSS 3D — Vulkan researched
  and rejected). Gate: fmt · clippy 0 · **110** tests.
