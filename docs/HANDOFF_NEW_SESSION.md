...
- **Latest work**: **RB-40…46 landed** (this `agi` drain). Cover magic-byte sniff;
  ...
  not shipped) + CMYK JPEG passthrough on X-1a wrap. Prior: bands 233–263,
  RB-1…RB-38. Three KDP types = ebook / paperback / hardcover; virtual stand
  = `/view3d`. Gate: fmt · clippy 0 · **121** tests.
