...
черги. **RB-40…48 landed**. Next = RB-49.
...
1. **RB-49** — AI-переклад чернетки (env-gated `/api/ai`, не хмара за замовчуванням).
2. **RB-50** — EPUBCheck-еквівалент v2 (зовнішні URL, script, ISBN per format).
